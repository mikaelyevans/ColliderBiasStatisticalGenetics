...
We chose this topic because we all have have learning goals more centered around learning and implementing advanced statistical methods than around the genetic content itself. Some of us have experience with causal inference, and some of us are hoping to use this project to learn about the topic. We opted for collider bias as our specific causal inference topic over Mendelian randomization because, based on the information we found, this method will be more applicable to other fields and other types of data. 
